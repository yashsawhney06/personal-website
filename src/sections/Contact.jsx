  ...
  return (
    <section id="contact" className="max-w-2xl mx-auto px-4 py-24">
      ...
      <div className="flex justify-center gap-6 mt-8">
        <a href="https://www.linkedin.com/in/yash-saw/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-500 hover:text-[color:var(--accent)] transition-colors text-2xl">
        ...
        <a href="https://github.com/yashsawhney06" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-500 hover:text-[color:var(--accent)] transition-colors text-2xl">
        ...
        <a href="mailto:yash.sawhney@outlook.com" aria-label="Email" className="text-gray-500 hover:text-[color:var(--accent)] transition-colors text-2xl">
