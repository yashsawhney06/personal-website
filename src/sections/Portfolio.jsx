...
export default function Portfolio() {
  return (
    <section id="portfolio" className="max-w-5xl mx-auto px-4 py-24">
      <Reveal as="h2" className="text-3xl md:text-4xl font-semibold mb-10 text-center tracking-tight">Portfolio</Reveal>
      ...
      <Reveal className="text-center mt-16">
        ...
        <a
          ...
          className="btn-outline-accent inline-flex items-center px-6 py-3 bg-transparent font-semibold"
        >
